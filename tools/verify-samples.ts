...
const files = ["sample/release-cli-compatibility.json", "sample/release-cli-direct.json", "sample/run.json", "sample/public-target-compatibility.json", "sample/public-target-direct.json"];
