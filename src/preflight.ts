...
export async function preflight() {
  ...
  try {
    ...
    return { nodeVersion: process.version, model: MODEL, codexSdkVersion: SDK_VERSION, responsesApi: process.env.OPENAI_API_KEY ? "key_present_not_logged" : "blocked_missing_OPENAI_API_KEY", crypto, sdk: { threadId: thread.id, response: turn.finalResponse.trim(), abortSignalCancelled } };
