...
// ponytail: the hackathon temporarily grants free ChatGPT accounts gpt-5.6-terra, so judges boot on a free codex login.
// gpt-5.6-sol is API-billing only. QT_MODEL overrides — needed once the terra entitlement ends, or for API billing.
export const MODEL = process.env.QT_MODEL ?? "gpt-5.6-terra";
