...
export default function Dashboard({ recorded = false, initialReport = null, recordedReports, banner }: { recorded?: boolean; initialReport?: RunReport | null; recordedReports?: RecordedReports; banner?: React.ReactNode }) {
  ...
  return <><a className="skip-link" href="#main-content">Skip to main content</a><main id="main-content" tabIndex={-1}>
    ...
    {recorded && <div className="sample-banner"><div><span className="badge live">GUIDED SAMPLE DEMO</span><p>This browser demo shows Quantum Twin using a prepared Node.js repository. Run the local workspace to analyze your own code.</p></div><a className="secondary" href="/#run-locally">Run Quantum Twin Locally</a></div>}
    {banner}
